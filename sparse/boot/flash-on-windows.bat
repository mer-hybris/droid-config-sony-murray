...
:: This is simple windows flashing script for Sony Xperia 10 IV device
...
set oemblobwebsite=https://opendevices.sony.net/file/download/software-binaries-for-aosp-android-14-0-kernel-5-4-murray-v3a
set fastbootkillretval=0
set serialnumbers=

echo(
echo This is a Windows flashing script for Sony Xperia 10 IV device.
echo(
...
echo "Software binaries for AOSP Android 14.0 - Kernel 5.4 - Murray (v3a)"
